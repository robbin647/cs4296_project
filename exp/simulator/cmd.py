...
def _intro():
    print("""
        *************************************************************
        **                                                         **
        ** Improved Dependency Scheduling with Request Clustering  **
        **                                                         **
        *************************************************************
        **                                                         **
        ** Required environment:                                   **
        ** 1) MongoDB - to host the demo image trace dataset       **
        ** 2) Redis Server - to provide the backend state for the  **
