...
CONDA_OPT_SET = ['scipy', 'cvxopt']
# TODO: add mosek, cvxpy
PIP_OPT_SET = []
...
pkg_sets = [CONDA_DEFAULT_LIST, PIP_DEFAULT_LIST, PIP_DEFAULT_UPGRADE_LIST, CONDA_ML_SET,
            PIP_ML_SET, CONDA_OPT_SET, PIP_OPT_SET]
runtimes = RUNTIMES
